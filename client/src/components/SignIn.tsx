    ...
    <SignIn
      appearance={{
        ...
        elements: {
          ...
          headerSubtitle: "text-base font-normal",
          footer: {
            background: "#25262F",
            padding: "0rem 2.5rem",
            "& > div > div:nth-child(1)": {
          ...
          formFieldLabel: "text-white-50 text-base font-normal",
          formButtonPrimary: "bg-primary-700 text-white-100 hover:bg-primary-600 !shadow-none",
          formFieldInput: "text-white-50 bg-customgreys-primarybg font-medium !shadow-none",
